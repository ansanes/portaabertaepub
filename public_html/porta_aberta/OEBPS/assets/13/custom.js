...
currentStep = 0;
    ...
    $('#screen2 .yes_btn').bind('touchstart click', function (e) {
        e.preventDefault();
        $('.b_text_w').html('<span>Well done! The hat goes on the boy\'s<br/>head to protect him from the sun.</span>');
    });

    $('#screen3 .no_btn').bind('touchstart click', function (e) {
        e.preventDefault();
        $('.b_text_w').html('<span>Well done! The socks go on boy\'s FEET,<br/>not on his HANDS! Socks stop his feet<br/>from sweating into his shoes.</span>');
    });

    $('#screen4 .yes_btn').bind('touchstart click', function (e) {
        e.preventDefault();
        $('.b_text_w').html('<span>Well Done! The hoodie goes on the<br/>boy\'s <span class="underline">HEAD</span>, <span class="underline">ARMS</span> and <span class="underline">TORSO</span> to<br/>keep him warm.</span>');
    });
