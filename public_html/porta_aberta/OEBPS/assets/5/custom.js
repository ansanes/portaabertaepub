$(document).ready(function () {
    ...
    $('#cat_01').bind('touchstart click', function (e) {
        e.preventDefault();
        currentStep = 2;
        stepInfo = stepsData[currentStep];        
        pause_all();
        stopAllTimeouts();        
        $('.head').html('<span class="cathighlight">Well done!<br/>That is the sound a cat makes!</span>');
        play_audio("ans_correct");       
        playSignLanguageVideo("act_04_03");            
        play_audio_file_highlight_element(stepInfo.audioElementId,"cathighlight");
        playSignLanguageVideo(stepInfo.highlightedElementId.signlanguageVideoName);
    ...
    $('#dog_01').bind('touchstart click', function (e) {
        ...
        $('.head').html('<span class="doghighlight">That\'s not the sound a dog makes!<br/>Try again!</span>');
        play_audio('ans_wrong');
        play_audio_file_highlight_element(stepInfo.audioElementId,"doghighlight");
        playSignLanguageVideo(stepInfo.highlightedElementId.signlanguageVideoName);
    });
